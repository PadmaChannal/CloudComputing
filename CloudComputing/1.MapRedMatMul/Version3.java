...
public class Multiply {  // extends Configured implements Tool {
        ...
        public static class ProductReducer extends Reducer<IntWritable,Elem,Text,Text>{
            ...
            public void reduce(IntWritable key,Iterable<Elem> values, Context context) throws IOException,InterruptedException {
                ...
                for(Elem m : M){
                    for(Elem n: N ){
			Text t = new Text(m.index + "," +n.index);
                       Text val = new Text(Double.toString(m.value*n.value));
			 context.write(t,val);
                    }
                }
            }
        ...
        public static class IdentityMap extends Mapper<Text, Text, Text, Text>{
            @Override
	...
	//	int i = sc.nextInt();
	//	int j = sc.nextInt();
	//	double k = Double.parseDouble(sc.next().trim());
        ...
        public static class AggregationReducer extends Reducer <Text,Text, Text, Text>{
            ...
            public void reduce(Text key, Iterable<Text> values, Context context) throws IOException,InterruptedException {
                ...
                sum = sum + Double.valueOf(item.toString());
               Text val = new Text(Double.toString(sum));
